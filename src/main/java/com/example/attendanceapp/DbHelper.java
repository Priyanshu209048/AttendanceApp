...
public class DbHelper extends SQLiteOpenHelper {
    ...
    /*rawQuery - rawQuery serves as an escape hatch where you can build your own SQL query at runtime but still use Room to convert it into objects.*/
    /*Cursor - A Cursor represents the result of a query and basically points to one row of the query result.*/
